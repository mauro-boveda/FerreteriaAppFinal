        ...
        <div class="card-body">
            <form action="/proveedores" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="telefono_contacto" name="telefono_contacto" value="{{ old('telefono_contacto') }}" required>
                </div>
                <div class="mb-3">
                    <label for="persona_contacto" class="form-label">Persona de Contacto</label>
                    <input type="text" class="form-control" id="persona_contacto" name="persona_contacto" value="{{ old('persona_contacto') }}" required>
                </div>
                <div class="mb-3">
